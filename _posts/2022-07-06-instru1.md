...
La configuration devait être initialement repartie sur 2 coffrets, l'un avec l'intelligence embarquée et les modules DI, DO, AI et AO, l'autre avec les modules de monitoring de type thermocouple et PT100.
...
![]({{ site.baseurl }}/assets/thesis/armoires3&4.jpg)
...
- un pyrgéomètre pour la mesure de la radiation atmosphérique
